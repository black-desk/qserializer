...
class QSerializer {
    ...
    private:
        ...
        static QVariantList
        QListTToQVariantList(QList<QSharedPointer<T> > list);

        static QList<QSharedPointer<T> >
        QVariantListToQListT(QVariantList list);
...
void QSerializer<T>::registerConverters()
{
        ...
        QMetaType::registerConverter<QList<QSharedPointer<T> >, QVariantList>(
                QListTToQVariantList);
        QMetaType::registerConverter<QVariantList, QList<QSharedPointer<T> > >(
                QVariantListToQListT);

        QMetaType::registerConverter<QMap<QString, QSharedPointer<T> >,
                                     QVariantMap>(QMapTToQVariantMap);
        QMetaType::registerConverter<QVariantMap,
...
template <typename T>
QVariantList
QSerializer<T>::QListTToQVariantList(QList<QSharedPointer<T> > list)
{
...
QSerializer<T>::QVariantListToQListT(QVariantList list)
{
...
template <typename T>
QVariantMap
QSerializer<T>::QMapTToQVariantMap(QMap<QString, QSharedPointer<T> > map)
{
        auto ret = QVariantMap{};
...
template <typename T>
QMap<QString, QSharedPointer<T> >
QSerializer<T>::QVariantMapToQMapT(QVariantMap map)
{
